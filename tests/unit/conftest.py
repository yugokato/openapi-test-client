...
@pytest.fixture
def api_class(api_client: APIClient, api_class_factory: Callable[..., type[ClassT]]) -> type[ClassT]:
    """A testable API class with one endpoint function"""
    return api_class_factory(api_client)


@pytest.fixture(scope="module")
def api_class_async(api_client_async: APIClient, api_class_factory: Callable[..., type[ClassT]]) -> type[ClassT]:
