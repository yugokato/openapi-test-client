...
class TestPydanticModelConversion:
    """Tests for Pydantic model conversion and validation"""
    ...
    def test_pydantic_model_conversion_and_validation(self, NewParamModel: type[ParamModel], input_value: Any) -> None:
    ...
    def test_pydantic_model_conversion_and_validation_error(
        self, NewParamModel: type[ParamModel], input_value: Any
    ) -> None:
