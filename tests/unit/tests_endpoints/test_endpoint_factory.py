"""Unit tests for the `endpoint` factory class in endpoints.py"""
...
from openapi_test_client.libraries.api.api_functions.endpoints import EndpointHandler, endpoint
