...
from openapi_test_client.libraries.json_encoder import CustomJsonEncoder
from openapi_test_client.libraries.types import ENDPOINT_FUNC_CONTROL_KWARGS, File, MultipartFormData
...
class OpenAPIBase(APIBase[T]):
    ...
    def request_wrapper(self) -> list[Callable[..., Any]]:
        ...
        - validation_handler (outermost): pops validate= kwarg. Overrides validation mode for this
          call when validate is not None (True forces validation on, False forces it off).
