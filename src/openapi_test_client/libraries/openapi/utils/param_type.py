"""OpenAPI-specific parameter type resolution utilities."""
...
from openapi_test_client.libraries.core.utils.param_type import (
    annotate_type,
    get_annotated_type,
    is_deprecated_param,
    is_query_param,
...
# Re-export core utilities so callers can import everything from one place
__all__ = [
    "annotate_type",
    "generate_literal_type",
    ...
    "is_union_type",
    "matches_type",
    "modify_annotated_metadata",
    "replace_annotated_type",
    "replace_base_type",
]
...
def generate_union_type(type_annotations: Any) -> Any:
    """Convert multiple annotations to a Union type, merging param models with the same name.
...
def or_(x: Any, y: Any) -> Any:
    ...
    >>> import operator
    >>> from openapi_test_client.libraries.openapi.types import ParamModel
