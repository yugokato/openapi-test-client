...
import openapi_test_client.libraries.types as types_module
import openapi_test_client.libraries.utils.endpoint_model as openapi_endpoint_model_util
...
def generate_api_client(temp_api_client: OpenAPIClient, show_generated_code: bool = True) -> type[OpenAPIClient]:
    ...
    for api_class in _get_api_classes(app_client_api_class_dir, base_api_class):
        ...
        property_name = camel_to_snake(api_class.__name__.removesuffix("API"))
        api_client_code += (
...
def _get_api_classes(api_class_dir: Path, base_api_class: type[T]) -> list[type[T]]:
    ...
    return get_api_classes(mod_name, base_api_class, class_filter=_is_live_class)
